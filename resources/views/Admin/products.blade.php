        ...
        <div class="w-full flex flex-row h-[600px] ">
            ...
            <div class="w-full flex flex-col px-10 py-5 gap-y-5">
                <div class="w-full border-r-2 border-b-2 border-[#D8D0BB]">
                    <h1 class="text-3xl px-3" style="font-family: CM;">PRODUCTOS AGREGADOS</h1>
                </div>
                <!-- seccion cambiante -->
                <div class="w-full flex flex-col gap-y-5">
                    ...
                    <div class="w-full flex flex-row justify-end gap-x-5">
                        <button id="btnMostrar"
                            class="text-[20px] bg-[#ecbd00] hover:bg-[#CC9B1C] hover:text-white rounded-full border-none px-1 py-0.5 w-1/4"
                            ...
                            <table class="w-full table-auto border-separate border border-none border-spacing-y-1.5 ">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border border-[#B39555]">Descripción</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border border-[#D8D0BB] px-2">{{$pan->Descripcion}}</td>
                                    </tr>
                                    @endforeach
